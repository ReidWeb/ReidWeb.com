        ...
        <nav class="white lighten-1" role="navigation">
            <div class="nav-wrapper container">
                ...
                <ul class="right hide-on-med-and-down">
                    ...
                    <li id="aboutLink"><a href="/about.php" class="blue-grey-text text-darken-4">About Me</a></li>
                    <li id="contactLink"><a href="#" class="blue-grey-text text-darken-4">Contact</a></li>
                </ul>


                <ul id="nav-mobile" class="side-nav white z-depth-5">
                    <div id="nav-mobile-header"><img class="responsive-img circle z-depth-1" src="img/avatar.jpg" alt="peter reid"/><a id="logo-container" href="index.php" class="brand-logo white-text bold">peter reid</a></div>
                    ...
                    <li id="aboutLinkMob" class="blue-grey-text text-darken-4"><a href="/about.php"><i class="tiny mdi-social-person left blue-grey-text text-darken-4"></i>About Me</a></li>
