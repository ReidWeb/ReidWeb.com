  ...
  <div class="section">
    ...
    <div class="row">
      <div class="col s12 m4">
        <div class="icon-block">
          ...
          <h2 class="center light-blue-text">
            <i class="mdi-action-settings-ethernet light-blue-text text-darken-2"></i>
          </h2>
      ...
      <div class="col s12 m4">
        <div class="icon-block">
          <h2 class="center light-blue-text">
            <i class="mdi-action-extension light-blue-text text-darken-2"></i>
          </h2>
          <h5 class="center">Problem Solver</h5>

          <p class="light grey-text text-darken-4 quality-paragraph">
            I would describe myself as a 'logical problem solver'; I set out to solve real-world problems using software. <br/>I always aim to solve problems to the best of my ability.
          </div>
      </div>
      ...
      <div class="col s12 m4">
        <div class="icon-block">
          <h2 class="center light-blue-text">
            <i class="mdi-action-settings light-blue-text text-darken-2"></i>
          </h2>
